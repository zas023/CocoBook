...
public class RxBusTag {
    ...
    public final static int MEDIA_BUTTON = 30;
    public final static int ALOUD_MSG = 31;
    public final static int ALOUD_STATE = 32;
    public final static int ALOUD_INDEX = 33;
    public final static int ALOUD_TIMER = 34;
